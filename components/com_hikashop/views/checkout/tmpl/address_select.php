...
window.Oby.registerAjax('hikashop_address_changed', function(params) {
	...
	}else if(params.type=='billing' && !d.getElementById('hikashop_checkout_shipping_address') && (d.getElementById('hikashop_shipping_methods') || d.getElementById('hikashop_payment_methods') || d.getElementById('hikashop_checkout_cart') )){
