...
;(function($) {
	...
	function Sequence(element, options, defaults, get) {
		...
		function init() {
			...
			self.nextButton = renderUiElements(self, self.settings.nextButton, "#"+self.container.attr('id')+" .sequence-next"); //set up the next button
			self.prevButton = renderUiElements(self, self.settings.prevButton, "#"+self.container.attr('id')+" .sequence-prev"); //set up the previous button
			self.pauseButton = renderUiElements(self, self.settings.pauseButton, "#"+self.container.attr('id')+" .sequence-pause"); //set up the pause button
			self.pagination = renderUiElements(self, self.settings.pagination, "#"+self.container.attr('id')+" .sequence-pagination"); //set up the pagination
